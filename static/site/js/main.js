...
$("#dataFiltro").on("apply.daterangepicker", function (ev, picker) {
  $(this).val(
...
$("#dataFiltro").on("cancel.daterangepicker", function (ev, picker) {
  $(this).val("");
});
...
async function carregaTimeLine(data) {
  ...
  if (data.events.length) {
    ...
    template.innerHTML =
      '<div class="tl-message-full"><div class="tl-message-container">' +
